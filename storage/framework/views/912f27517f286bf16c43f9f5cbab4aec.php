...
<body>
    <div class="form-container">
        ...
        <div class="alert alert-success" style="background-color: #d4edda; color: #155724; padding: 15px; border-radius: 5px; margin-bottom: 20px; border: 1px solid #c3e6cb;">
            <strong>✓ Data berhasil diekstraksi dari file!</strong> Form telah diisi otomatis. Silakan periksa dan lengkapi data yang masih kosong.
        </div>
        <?php endif; ?>
    ...
    <?php if(isset($aiData) && $aiData): ?>
    <script>
        // Pass AI data to JavaScript
        window.aiExtractedData = <?php echo json_encode($aiData, 15, 512) ?>;
    </script>
    <?php endif; ?>
</body>
</html><?php /**PATH C:\laragon\www\Ekstraksi_KK_MAIN-main\resources\views/keluarga/tambah.blade.php ENDPATH**/ ?>