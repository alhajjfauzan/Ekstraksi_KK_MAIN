        ...
        <form action="<?php echo e(route('kartu-keluarga.update', $kartuKeluarga->no_kk)); ?>" method="POST" id="formKeluarga">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode_pos" value="<?php echo e(old('kode_pos', $kartuKeluarga->kode_pos)); ?>" required>
                </div>
                <div class="form-group">
                    <label>Alamat</label>
...
</html><?php /**PATH C:\laragon\www\Ekstraksi_KK_MAIN\resources\views/keluarga/edit.blade.php ENDPATH**/ ?>